...
hoverPreview.innerHTML=`<button class="hover-preview-close" aria-label="Close preview">×</button><div class="hover-preview-media"></div><div class="hover-preview-label">PREVIEW</div>`;
